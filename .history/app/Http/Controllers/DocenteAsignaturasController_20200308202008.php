...
// testasignaciondocentes
 public function gettest(Request $request) {
   ...
   $asignacions=DocenteAsignatura::get();
      $docenteAsignaturas = DocenteAsignatura::where('docente_id',$asignacions->id)->where('periodo_lectivo_id',$request->periodo_lectivo_id)->with('asignatura') ->get();

   return response()->json(['test' => $asignacions], 200);
    }
