...
// testasignaciondocentes
 public function gettest(Request $request) {
   ...
   $docente=Docente::where('estado')->get();
      $docenteAsignaturas = DocenteAsignatura::where('estado',$docente->estado)->where('periodo_lectivo_id',$request->periodo_lectivo_id)->with('asignatura')->get();
