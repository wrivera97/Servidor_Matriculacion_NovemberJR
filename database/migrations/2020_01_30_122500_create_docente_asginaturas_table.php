...
class CreateDocenteAsginaturasTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('docente_asginaturas', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('docente_asginaturas');
    }
}
